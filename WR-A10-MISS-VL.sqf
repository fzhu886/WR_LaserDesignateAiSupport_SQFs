...
2) Place a trigger down and change/add the following:
	...
	Activation = Radio India
	
	Repeatable = Tick
	
	On Activation = WR_A10MVR = [getPosATL laserTarget player] execVM "WR-A10-MISS-VL.sqf";
...
params [
	...
	"_position",["_vehicle","B_Plane_CAS_01_F"],["_type",1],"_logic"
